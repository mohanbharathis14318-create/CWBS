...
const ProjectBoard = () => {
    ...
    const downloadPDF = async () => {
        ...
        document.querySelectorAll("*").forEach(el => {
            ...
            ["color", "backgroundColor", "borderColor"].forEach(prop => {
                ...
                if (val.includes("oklch")) {
                    el.style[prop] = "rgb(0,0,0)"; // fallback, or pick a default
                }
            });
        });
        ...
        // Capture full content, not just visible viewport
        ...
        pdf.save(`${selectedTransaction.project_name}.pdf`);
    };
    ...
    let AllProject,
        ...
        if (selectedMonthFilter) {
            AllProject = AllProject.filter(item => {
                ...
                // Convert start_date to YYYY-MM
                // const startMonth = new Date(item.start_date).toISOString().slice(0, 7);
    ...
    return (
        <div>
            ...
            <div className="border items-center border-[#A9C1EA] bg-[#F1F1F1] rounded p-4 my-4">
           ...
           <section className="grid box-border border border-[#A9C1EA] rounded p-4">
...

                           {
                               ...
                               Array.isArray(inLine) && inLine?.length > 0
                                       ...
                                       <div className="grid md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 py-4 gap-2">
                                           {
                                               ...
                                               inLine.map((item) => (
                                                   ...
                                                   <div key={item.project_id} title={item.project_name}
                                   ...
                                   (
                                       ...
                                       <div className="text-center p-8 bg-[#F1F1F1]">
               ...
               {isModalOpen && selectedTransaction && (
                   <div className="fixed inset-0 bg-[#202020]/50 flex items-center justify-center z-50">
                       <div ref={contentRef} className="bg-[#F1F1F1] rounded w-11/12 h-9/10 md:w-1/2 lg:w-1/2 shadow-xl overflow-y-auto scroll-smooth">
                                               ...
                                               <div className="grid md:grid lg:grid xl:grid gap-2 my-6">
                                                   ...
                                                   <div className="grid md:flex lg:flex xl:flex justify-between items-center text-xl border border-[#6392E5] rounded p-4">
                                                       ...
                                                       >
                                                           ...
                                                           <p>
                                                               = Total Construction Budget + Total Plot Cost + Total Amenities Cost + Total Document Charges + Total Extra Charges
                                                           </p>
                                                       </motion.label>
                                                   </div>
                                               </div>
