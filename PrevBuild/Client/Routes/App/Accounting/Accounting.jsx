        ...
        <div>
            ...
            <div className="tabs grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-6">
                <NavLink to="/app-area/accounting/office_account"
                         className={({ isActive }) => isActive ? "flex gap-2 justify-center items-center text-xl text-[#005BEA] border-b-2 border-[#6392E5] bg-[#C9D8F3] px-6 py-2" : "flex gap-2 justify-center items-center text-xl text-[#202020] border-b-2 border-[#6392E5] hover:bg-[#C9D8F3] px-6 py-2"}>
                    <PencilRuler />
                    Office A/C
                </NavLink>
