            ...
            <div className="grid md:flex lg:flex xl:flex gap-2">
                <motion.div  className="grid" initial={{ opacity: 0, y: 100 }}
                    ...
                    <NavLink to="/app-area/accounting/office_account/investment_account"
                             className={({ isActive }) => isActive ? "flex gap-2 justify-center items-center text-[#005BEA] border border-[#6392E5] bg-[#C9D8F3] rounded px-6 py-2" : "flex gap-2 justify-center items-center text-[#005BEA] border border-[#6392E5] bg-[#D9E1EF] hover:bg-[#C9D8F3] px-6 py-2 rounded"}>
                        <BadgeIndianRupee />
                        Office Investment
                    </NavLink>
                </motion.div>
